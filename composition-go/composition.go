...
func introspectSubgraph(client *http.Client, URL string) (string, error) {
	if URL == "" {
...
func updateSchemas(client *http.Client, subgraphs []*Subgraph) ([]*Subgraph, error) {
	...
	for _, subgraph := range subgraphs {
		...
		sdl, err := introspectSubgraph(client, subgraph.URL)
		if err != nil {
